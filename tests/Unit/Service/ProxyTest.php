...
final class ProxyTest extends TestCase
{
    ...
    {
        $proxy = new Proxy('packagist', 'https://packagist.org', new FakeRemoteFilesystem(), new InMemoryCache(), 'dist/path');
    ...
    public function testCacheHitOnProviderData(): void
    {
        ...
        $cache->get('packagist/packages.json', Argument::type('callable'))->willReturn(Option::some('{}'));

        $proxy = new Proxy('packagist', 'https://packagist.org', new FakeRemoteFilesystem(), $cache->reveal(), __DIR__.'/../../Resources');

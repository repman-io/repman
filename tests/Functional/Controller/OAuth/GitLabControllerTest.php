...
final class GitLabControllerTest extends FunctionalTestCase
{
    public function testStartRegisterWithGitLab(): void
    {
        ...
        $this->assertStringContainsString('gitlab.com', (string) $response->headers->get('location'));
    }
    ...
    public function testRedirectToIndexWhenAlreadyLogged(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, $this->urlTo('register_gitlab_check'));
    ...
    public function testLoginUserIfAlreadyExist(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, $this->urlTo('register_gitlab_check', ['state' => $params['state'], 'code' => 'secret-token']));
    ...
    public function testCreateUserIfNotExistsExist(): void
    {
        ...
        $this->assertTrue($this->client->getResponse()->isRedirect($this->urlTo('organization_create', ['origin' => 'gitlab'])));
        $this->client->followRedirect();
    ...
    public function testSuccessfulLoginWithGitLab(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, $this->urlTo('login_gitlab_check', ['state' => $params['state'], 'code' => 'secret-token']));
    ...
    public function testAddOAuthTokenToUser(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, $this->urlTo('fetch_gitlab_package_token', ['organization' => 'buddy']));
        $params = $this->getQueryParamsFromLastResponse();

        $this->mockTokenAndUserResponse($email);

        $this->client->request(Request::METHOD_GET, $this->urlTo('package_gitlab_check', ['state' => $params['state'], 'code' => 'secret-token']));

        $this->assertTrue($this->client->getResponse()->isRedirect($this->urlTo('organization_package_new', ['organization' => 'buddy', 'type' => 'gitlab'])));
        $this->client->followRedirect();
    ...
    public function testAddPackageFromGitLabWithoutToken(): void
    {
        ...
        $this->assertStringContainsString('gitlab.com', (string) $this->client->getResponse()->headers->get('Location'));
    }
